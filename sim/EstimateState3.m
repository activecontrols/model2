function [X_est, Innovation] = EstimateState3(Y, X_hat, U, t)
...
h_nom(7:9) = quatRot([q0; q]) * ref;
h_nom(10:12) = X_est(10:12);

% Build H matrix
H2 = zeros(12,15);
H2(1:3, 1:3)   = eye(3);              % pos -> pos
H2(4:6, 4:6)   = eye(3);              % vel -> vel
H2(7:9, 7:9)   = zetaCross(b_hat);    % ATTITUDE small-angle block (dtheta placed at columns 7..9)
H2(10:12,10:12)= eye(3);  

% Innovation
inn = Y - h_nom;
L2 = A_d*P*H2'*inv(H2*P*H2' + R*R');
