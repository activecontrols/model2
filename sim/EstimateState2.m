...
J_x = JacobianX(X_crit, U_crit);
J_u = JacobianU(X_crit, U_crit);
...
% or just estimated)
Rvec = [2 2 2 2 2 2 1/4 1/4 1/4 0.5 0.5 0.5];
...
% Q = 0.0005 * eye(12);
Q = diag([1e-4 1e-4 1e-4 1e-2 1e-2 1e-2 1e-6 1e-6 1e-6 1e-6 1e-6 1e-6]);
...
if isWCond == 0
    ...
    X_est = X_hat + plantfcn(X_hat, U)*h + L*(Y - C*X_hat);
