    ...
    methods
        ...
        function prefTask(pop)
            ...
            for i = 1:pop.popSize
                ...
                % Status updates
                if i == round(.25 * pop.popSize)
                    fprintf('   Task Evaluation:     25%%\n')
                elseif i == round(.5 * pop.popSize)
                    fprintf('   Task Evaluation:     50%%\n')
                elseif i == round(.75 * pop.popSize)
                    fprintf('   Task Evaluation:     75%%\n')
        ...
        function fitEval(pop)
            ...
            for i = 1:pop.popSize
               ...
               % Status updates
                if i == round(.25 * pop.popSize)
                    fprintf('   Fitness Evaluation:     25%%\n')
                elseif i == round(.5 * pop.popSize)
                    fprintf('   Fitness Evaluation:     50%%\n')
                elseif i == round(.75 * pop.popSize)
                    fprintf('   Fitness Evaluation:     75%%\n')
                elseif i == round(pop.popSize)
                    fprintf('   Fitness Evaluation:    100%%\n')
                end
